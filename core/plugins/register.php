...
function odin_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            //'source'                  => get_stylesheet_directory() . '/core/plugins/aqua-page-builder.zip', // The plugin source
    ...
    */
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'activate_link'                   => _n_noop( 'Begin activating plugin', 'Begin activating plugins', $theme_text_domain ),
